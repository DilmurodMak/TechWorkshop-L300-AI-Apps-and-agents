...
class A2AServer:
    ...
    def _get_agent_card(self) -> AgentCard:
        ...
        skill_product_helper = AgentSkill(
            ...
            description=(
                'Handles customer inquiries about Zava products, including '
                'features, pricing, and ranking products based on customer '
                'needs.'
            ),
        ...
        agent_card = AgentCard(
            name='Zava Product Helper',
            description=(
                'Zava Product Helper providing comprehensive product '
