...
# Use gpt_endpoint for direct AOAI access to avoid audience issues with Project endpoints
gpt_endpoint = validated_env_vars.get('gpt_endpoint')
if gpt_endpoint and "/openai/v1" in gpt_endpoint:
    gpt_endpoint = gpt_endpoint.split("/openai/v1")[0]

llm_client = AzureOpenAI(
    azure_endpoint=gpt_endpoint,
    azure_ad_token_provider=token_provider,
    api_version=validated_env_vars.get('gpt_api_version'),
)
